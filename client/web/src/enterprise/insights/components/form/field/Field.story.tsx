...
export const SimpleField = () => {
    const { t } = useTranslation('enterprise/insights/components/form/field')

    return (
        <div className="d-flex flex-column" style={{ gap: '2rem', width: 400 }}>
            <Field queryState={{ query: '' }} placeholder={t('example-type-diff-repo-sourcegraph')} />
            ...
            <FocusContainer>
                <Field queryState={{ query: '' }} placeholder={t('example-type-diff-repo-sourcegraph-duplicate')} />
