...
export const EditDashboardPage: FC = props => {
    const { t } = useTranslation('enterprise/insights/pages/dashboards/edit-dashboard')
    ...
    return (
        <CodeInsightsPage className={classNames('col-8', styles.page)}>
            <PageTitle title={t('configure-dashboard-title-code-insights', { dashboardTitle: dashboard.title })} />
